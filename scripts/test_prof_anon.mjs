async function testProfAnon() {
  const estabId = '28197b7a-5e9a-4ed0-87c6-7870bf88a951';
  const url = `https://eozvjjtqoicyqooiuvqi.supabase.co/rest/v1/membros_equipe?estabelecimento_id=eq.${estabId}&ativo=eq.true`;
  ...
  try {
    ...
    console.log('--- TEST PROF ANON FETCH ---');
