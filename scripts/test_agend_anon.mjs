async function testAgendAnon() {
  const estabId = '28197b7a-5e9a-4ed0-87c6-7870bf88a951';
  const url = `https://eozvjjtqoicyqooiuvqi.supabase.co/rest/v1/agendamentos?estabelecimento_id=eq.${estabId}&select=data_hora_inicio,membro_id`;
  ...
  try {
    ...
    console.log('--- TEST AGEND ANON FETCH ---');
